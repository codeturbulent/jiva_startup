...
const screenshotAnimations = [
  { selector: ".ss1", start: "top 90%", end: "top 50%" },
  { selector: ".ss2", start: "top 90%", end: "top 50%" },
  { selector: ".ss3", start: "top 90%", end: "top 50%" },
  { selector: ".ss4", start: "top 95%", end: "top 55%" },
  { selector: ".ss5", start: "top 95%", end: "top 55%" },
  { selector: ".ss6", start: "top 95%", end: "top 55%" },
];

screenshotAnimations.forEach(({ selector, start, end }) => {
  gsap.from(selector, {
    y: 300,
    scale: 1.3,
    scrollTrigger: {
